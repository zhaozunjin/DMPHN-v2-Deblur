...
class Encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        output_layer4 = self.layer4(output_layer3+output_layer2 + output_layer1) + output_layer3+output_layer2 + output_layer1
        
        out = self.ca1(output_layer4) * output_layer4
        out = self.sa1(out) * out
        # output_layer4 = self.relu1(output_layer4)
        output_layer4 = out + output_layer4
        ...
        output_layer8 = self.layer8(output_layer7+output_layer6 + output_layer5) + output_layer7+output_layer6 + output_layer5
        
        out = self.ca2(output_layer8) * output_layer8
        out = self.sa2(out) * out
        #output_layer7 = self.relu2(output_layer7)
        output_layer8 =out+output_layer8
        ...
        output_layer12 = self.layer12(output_layer11+output_layer10 + output_layer9) + output_layer11+output_layer10 + output_layer9

        out = self.ca3(output_layer12) * output_layer12
        out = self.sa3(out) * out
        #output_layer11 = self.relu3(output_layer11)
        output_layer12 =out+output_layer12
