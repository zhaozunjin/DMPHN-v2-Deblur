...
class Encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        #output_layer3 = self.ca1(output_layer3) * output_layer3
        #output_layer3 = self.sa1(output_layer3) * output_layer3
        ...
        #output_layer7 = self.ca2(output_layer7) * output_layer7
        #output_layer7 = self.sa2(output_layer7) * output_layer7
        ...
        #output_layer11 = self.ca3(output_layer11) * output_layer11
        #output_layer11 = self.sa3(output_layer11) * output_layer11
...
class WSDMPHN(nn.Module):
    ...
    def forward(self, input_generator, feature=None, residual=None):
        ...
        if feature is not None:
            self.feature['lv4_top'] = torch.cat((self.feature['lv4_1'], self.feature['lv4_2']), 3)+feature['lv4_top']
            self.feature['lv4_bottom'] = torch.cat((self.feature['lv4_3'], self.feature['lv4_4']), 3)+feature['lv4_bottom']
            # self.feature['lv4'] = torch.cat((self.feature['lv4_top'], self.feature['lv4_bottom']), 2)
            self.residual['lv4_top'] = self.decoder_lv4_1(self.feature['lv4_top'])+residual['lv4_top']
            self.residual['lv4_bottom'] = self.decoder_lv4_2(self.feature['lv4_bottom'])+residual['lv4_bottom']
        ...
        if feature is not None:
            self.feature['lv2_1'] = self.encoder_lv2_1(self.images['lv2_1'] + self.residual['lv4_top']) + self.feature['lv4_top']+feature['lv2_1']
            self.feature['lv2_2'] = self.encoder_lv2_2(self.images['lv2_2'] + self.residual['lv4_bottom']) + self.feature['lv4_bottom']+feature['lv2_2']
            self.feature['lv2'] = torch.cat((self.feature['lv2_1'], self.feature['lv2_2']), 2)
            self.residual['lv2'] = self.decoder_lv2_1(self.feature['lv2'])+residual['lv2']
        else:
        ...
        if feature is not None:
            self.feature['lv1'] = self.encoder_lv1_1(self.images['lv1_1'] + self.residual['lv2']) + self.feature['lv2']+feature['lv1']
